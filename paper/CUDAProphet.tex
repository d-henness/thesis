...
\IF{$i \leq total$}
	...
	\IF{$(inttype == 0)$}
		...
		\STATE{$pLL(i, j) = d(pos1) * fctr * xp(1, loc) + d(pos2) * fctr * xp(k1, loc)$}
		\STATE{$pSS(i, j) = d(pos1) * fctr * xp(k2, loc) + d(pos2) * fctr * xp(k8, loc)$}
	\ELSE
		\IF{$i>j$}
			\STATE{$k1 = 4$}
			\STATE{$k2 = 6$}
		...
		\STATE{$pSL(i, j) = d(pos1) * fctr * xp(7, loc) + d(pos2) * fctr * xp(k1, loc)$}
		\STATE{$pLS(i, j) = d(pos1) * fctr * xp(k2, loc) + d(pos2) * fctr * xp(5, loc)$}
	\ENDIF
