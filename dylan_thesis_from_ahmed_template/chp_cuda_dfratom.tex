...
The form of the \textbf{Q} super matrix is almost the same a \textbf{P}, but there will be an additional multiplication of the vector coupling coefficient between the open shells for each summation.
