...
\begin{tabular}{rrrrrrr}
	\multirow{3}{2cm}{Two-Electron Integrals}	&	\multirow{3}{*}{CPU Time}		&	\multirow{3}{*}{\kernel{eint2}}	&	\multirow{3}{2.4cm}{\kernel{binary\_search}}		&	\multirow{3}{1cm}{Total GPU time}	&	\multirow{3}{*}{Speedup\textsuperscript{\emph{a}}}	&	\multirow{3}{*}{Speedup\textsuperscript{\emph{b}}}	\\
	\\
	\\
	\hline
...
\textsuperscript{\emph{a}} Speedup comparing just the time of \kernel{eint2} to the CPU time. \\
\textsuperscript{\emph{b}} Speedup comparing the time of \kernel{eint2} and \kernel{binary\_search} to the CPU time. \\
