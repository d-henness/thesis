...
Another field of physics that was being developed at the same time as quantum mechanics was relativity. Relativity traces its roots to Michelson and Morley\citethis when they made the startling observation that all observers, no matter their frame of reference, will always agree on the speed of light. But it would not be until everyone's favorite Swiss patent cleric decided to examine this issue that the truly profound implications of this observation would be known. 
