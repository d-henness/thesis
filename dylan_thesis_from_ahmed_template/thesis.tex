...
This thesis is my own original work. No part of this thesis has been previously published. Computations and code were planned, performed, and written by myself with the help of Mariusz Klobukowski.
...
I would first like to acknowledge my supervisor, Mariusz Klobukowski. Few grad students are lucky enough to have a mentor who is as kind, helpful, and a source of as much interesting conversation as he. I would not have as easily discovered my love of programming if it weren't for him, and for that I am truly grateful. He dealt with my \ldots{} sporadic writing schedule with the patience and grace of a saint which made this whole process of writing a thesis that much more bearable. I really cannot say enough how much his guidance has meant to me.

I would like to thank one of my course instructors, Paul Lu. He took a chance with me when no one else would and gave me the opportunity to more fully explore my computational potential. I don't think I could have made it without his help, so again, thank you. 

I would also like to thank my friends and family. As much as I love it, the science can't be the reason to wake up \textit{every} morning, so thank you to those who helped keep my spirits up, especially when it seemed like I would be writing this forever.

I should also thank the money. The work in this thesis could not have happened without the funding from NSERC and FGSR, and without the computer resources of WestGrid and Compute Canada.

Finally, I would like to thank my girlfriend Jessie Hartmann. We've been through Hell and back together, and there is no one else I would have rather had at my side than her. For some reason, she continues to love me, even as I make her watch a video on sorting algorithms for the tenth time, so for you Jessie I give my appreciation, affection, and love.
...
Some symbols are reused. The exact meaning will need to be obtained from context.
\begin{table}[h!]
\begin{tabular}{ll}
\toprule
Symbol			&	Description 					\\
